...
public class DriveForDistance extends CommandBase {
    ...
    public DriveForDistance(double Distance_Setpoint, double speed, double turn, DriveTrain subsystem) {
    ...
    public boolean isFinished() {
        return Math.abs(m_Distance_Setpoint) <= Math.abs(m_driveTrain.getLeftEncoder_Inches());
    }
