...
private ADXRS450_Gyro m_gyro;
    ...
    public DriveTrain() {
        kGyroPort = SPI.Port.kOnboardCS0;
...
rightEncoder = new Encoder(2, 3, false, EncodingType.k4X);
 ...
 rightEncoder.setDistancePerPulse(0.052);
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Gyro", getGyroDeg());
    ...
    public void my_driveArcade(double d, double e) {
        differentialDrive1.arcadeDrive(d, e);
    }
