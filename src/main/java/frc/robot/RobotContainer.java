...
// Create some buttons
final JoystickButton armDown = new JoystickButton(driverController, PS4Controller.Button.kCircle.value);        
armDown.whileTrue(new ArmJog(-0.1, m_arm).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton armUp = new JoystickButton(driverController, PS4Controller.Button.kTriangle.value);        
