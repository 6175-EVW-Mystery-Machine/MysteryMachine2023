...
// private final PS4Controller driverController = new PS4Controller(1);
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.addOption("S1/S3 - Cube & Mobility (23.5in)", new AutoCubeSeq1( m_driveTrain, m_arm, m_tram, m_claw ));
    m_chooser.addOption("S1 - 2 Cube & Mobility v2.0", new AutoCubeSeq4(m_driveTrain, m_arm, m_tram, m_claw));
