...
private final PS4Controller driverController = new PS4Controller(1);
  ...
  */
  private RobotContainer() {
    ...
    m_driveTrain.setDefaultCommand(new DriveWithJoy(() -> -joystick1.getRawAxis(1), () -> joystick1.getRawAxis(2), m_driveTrain));
    ...
    m_chooser.addOption("AutoDriveForTime", new AutoCubeSeq1( m_driveTrain, m_arm, m_tram, m_claw ));
