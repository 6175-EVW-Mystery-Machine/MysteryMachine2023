...
private final PS4Controller driverController = new PS4Controller(0);
  ...
  */
  private RobotContainer() {
    ...
    m_arm.setDefaultCommand(new ArmJog(() -> driverController.getRawAxis(3), m_arm));
 ...
 */     
/*                  
final JoystickButton pS4ArmJogDown = new Joystic(3);        
pS4ArmJogDown.whileTrue(new ArmJog(, m_arm).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
