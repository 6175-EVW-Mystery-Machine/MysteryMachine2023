...
// private final PS4Controller driverController = new PS4Controller(1);
  ...
  */
  ...
  SmartDashboard.putData("Auto Mode", m_chooser);
    ...
    //m_chooser.addOption("S1 - 2 Cube & Mobility", new AutoCubeSeq2(m_driveTrain, m_arm, m_tram, m_claw));
    m_chooser.addOption("S1/S3 - Cube & Mobility", new AutoCubeSeq1( m_driveTrain, m_arm, m_tram, m_claw ));
    m_chooser.addOption("S1 - 2 Cube & Mobility", new AutoCubeSeq4(m_driveTrain, m_arm, m_tram, m_claw));
    m_chooser.addOption("S2 - Balance", new AutoBalance(m_driveTrain, m_claw));
    m_chooser.addOption("S2 - Cube & Balance", new AutoBalanceSeq2(m_driveTrain, m_tram, m_arm, m_claw));
    
    //UNTESTED
    m_chooser.addOption("S1/S3 - Cube & Mobility & Rotate", new AutoCubeSeq1v2( m_driveTrain, m_arm, m_tram, m_claw ));
    m_chooser.addOption("S2 - Cube & Balance", new AutoBalanceSeq2v2(m_driveTrain, m_tram, m_arm, m_claw));
    
    m_chooser.addOption("No Auto", new AutonomousCommand());

    m_chooser.setDefaultOption("(Default) S1/S3 - Cube & Mobility", new AutoCubeSeq1( m_driveTrain, m_arm, m_tram, m_claw ));
...
final JoystickButton grabExtend = new JoystickButton(joystick1, 12);
grabExtend.onTrue(new GrabExtend(m_arm, m_claw, m_tram).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
