...
private final PS4Controller driverController = new PS4Controller(1);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command: default", new AutonomousCommand(0, 0, m_driveTrain));
    SmartDashboard.putData("Autonomous Command: auto", new AutonomousCommand(0.5, 0, m_driveTrain));
    ...
    m_chooser.addOption("Autonomous Command: default", new AutonomousCommand(0, 0, m_driveTrain));
    m_chooser.addOption("Autonomous Command: auto", new AutonomousCommand(0.5, 0, m_driveTrain));
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(0, 0, m_driveTrain));
...
pS4ArmJogDown.whileTrue(new ArmJog(-0.7, m_arm).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton pS4ArmJogUp = new JoystickButton(driverController, 8);        
pS4ArmJogUp.whileTrue(new ArmJog(0.7, m_arm).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
